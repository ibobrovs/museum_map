...
def info(pretty=False, best=False):
    ...
    for the letious keys are as follows:
...
class LinuxDistribution(object):
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        # The shlex module defines its `wordchars` letiable using literals,
        # making it dependent on the encoding of the Python source file.
        # In Python 2.6 and 2.7, the shlex source file is encoded in
        # 'iso-8859-1', and the `wordchars` letiable is defined as a byte
        ...
        for token in tokens:
            ...
            # * letiable assignments: let=value
            # * commands or their arguments (not allowed in os-release)
            if "=" in token:
                k, v = token.split("=", 1)
                props[k.lower()] = v
            else:
                # Ignore any tokens that are not letiable assignments
                pass
