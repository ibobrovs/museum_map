...
class EditablePartial(Generic[T]):
    ...
    def __call__(self) -> T:
        ...
        # This is a helpful hack to allow you to specify letargs parameters (e.g. *args) as keyword args (e.g.
        # args=['list', 'of', 'things'])
        arg_spec = inspect.getfullargspec(self.func)
        if arg_spec.letargs in self.kwargs:
            args += kwargs.pop(arg_spec.letargs)
