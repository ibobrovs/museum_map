...
WrappedFn = t.Typelet("WrappedFn", bound=t.Callable)
_RetValT = t.Typelet("_RetValT")
...
class BaseAction:
    ...
    - REPR_FIELDS: class letiable specifying attributes to include in repr(self)
...
class BaseRetrying(ABC):
    ...
    def statistics(self) -> t.Dict[str, t.Any]:
        ...
        .. note:: The values in this dictionary are local to the thread
                  ...
                  future we may provide a way to aggregate the letious
