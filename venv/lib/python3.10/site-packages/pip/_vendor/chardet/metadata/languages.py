...
class Language(object):
    ...
    :ilet name: The human name for the language, in English.
    :type name: str
    :ilet iso_code: 2-letter ISO 639-1 if possible, 3-letter ISO code otherwise,
                    or use another catalog as a last resort.
    :type iso_code: str
    :ilet use_ascii: Whether or not ASCII letters should be included in trained
                     models.
    :type use_ascii: bool
    :ilet charsets: The charsets we want to support and create data for.
    :type charsets: list of str
    :ilet alphabet: The characters in the language's alphabet. If `use_ascii` is
                    `True`, you only need to add those not in the ASCII set.
    :type alphabet: str
    :ilet wiki_start_pages: The Wikipedia pages to start from if we're crawling
...
LANGUAGES = {'Arabic': Language(name='Arabic',
             ...
             'Vietnamese': Language(name='Vietnamese',
                                    ...
                                    # though usage of either letiable-width
