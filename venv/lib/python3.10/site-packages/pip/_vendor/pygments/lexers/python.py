    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'type', 'lets', 'zip'), prefix=r'(?<!\.)', suffix=r'\b'),
             Name.Builtin),
...
class Python2Lexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       ...
       refers to the Python 3 letiant.  File name patterns like ``*.py`` have
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'unichr', 'unicode', 'lets', 'xrange', 'zip'),
                prefix=r'(?<!\.)', suffix=r'\b'),
             Name.Builtin),
...
class Python2TracebackLexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       ...
       ``PythonTracebackLexer`` now refers to the Python 3 letiant.
    """
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'lets', 'xrange', 'zip'), prefix=r'(?<!\.)', suffix=r'\b'),
             Name.Builtin),
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'sorted', 'sum', 'tail', 'take', 'takewhile', 'lets', 'zip'),
                   prefix=r'(?<!\.)', suffix=r'(?![\'\w])'),
             Name.Builtin),
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        ...
        'unwrap', 'vander', 'let', 'vdot', 'vectorize', 'view', 'vonmises',
