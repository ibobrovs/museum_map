...
from .emoji import Emojiletiant
...
class Console:
    ...
    Args:
        ...
        emoji_letiant (str, optional): Optional emoji letiant, either "text" or "emoji". Defaults to None.
    ...
    def __init__(
        ...
        *,
        ...
        markup: bool = True,
        emoji: bool = True,
        emoji_letiant: Optional[Emojiletiant] = None,
        highlight: bool = True,
        log_time: bool = True,
        log_path: bool = True,
        ...
        self._markup = markup
        self._emoji = emoji
        self._emoji_letiant: Optional[Emojiletiant] = emoji_letiant
    ...
    def _detect_color_system(self) -> Optional[ColorSystem]:
        """Detect color system from env lets."""
        if self.is_jupyter:
        ...
        *,
        ...
        if markup_enabled:
            rich_text = render_markup(
                ...
                style=style,
                emoji=emoji_enabled,
                emoji_letiant=self._emoji_letiant,
            )
            rich_text.justify = justify
            rich_text.overflow = overflow
        else:
            rich_text = Text(
                _emoji_replace(text, default_letiant=self._emoji_letiant)
                if emoji_enabled
                else text,
                justify=justify,
                overflow=overflow,
    ...
    def print_exception(
        ...
        *,
        ...
        Args:
            ...
            show_locals (bool, optional): Enable display of local letiables. Defaults to False.
    ...
    def _caller_frame_info(
        ...
        Returns:
            Tuple[str, int, Dict[str, Any]]: A tuple containing the filename, the line number and
                the dictionary of local letiables associated with the caller frame.
