...
def _zseries_int(zs):
    ...
    of letiable using dx/dz given in the module notes.
...
def chebder(c, m=1, scl=1, axis=0):
    ...
    c : array_like
        ...
        the different axis correspond to different letiables with the
...
def chebint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    >>> C.chebint(c,3)
    array([ 0.03125   , -0.1875    ,  0.04166667, -0.05208333,  0.01041667, # may lety
        0.00625   ])
    >>> C.chebint(c, k=3)
...
def chebroots(c):
    ...
    array([ -5.00000000e-01,   2.60860684e-17,   1.00000000e+00]) # may lety
...
def chebinterpolate(func, deg, args=()):
    ...
    func : function
        ...
        letiable of the form ``f(x, a, b, c...)``, where ``a, b, c...`` are
