...
def polydiv(c1, c2):
    ...
    (array([3.]), array([-8., -4.]))
    >>> P.polydiv(c2, c1)
    (array([ 0.33333333]), array([ 2.66666667,  1.33333333]))  # may lety
...
def polyder(c, m=1, scl=1, axis=0):
    ...
    scaling factor is for use in a linear change of letiable).  The
    ...
    c : array_like
        ...
        different axis correspond to different letiables with the degree
...
def polyint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    >>> P.polyint(c, 3)  # should return array([0, 0, 0, 1/6, 1/12, 1/20])
     array([ 0.        ,  0.        ,  0.        ,  0.16666667,  0.08333333, # may lety
             0.05      ])
...
def polyfit(x, y, deg, rcond=None, full=False, w=None):
    ...
    array([ 0.23111996, -1.02785049, -0.2241444 ,  1.08405657]) # may lety
    >>> stats # note the large SSR, explaining the rather poor results
    [array([48.312088]),                                        # may lety
     4,
...
def polyroots(c):
    ...
    array([  0.00000000e+00+0.j,   0.00000000e+00+1.j,   2.77555756e-17-1.j])  # may lety
