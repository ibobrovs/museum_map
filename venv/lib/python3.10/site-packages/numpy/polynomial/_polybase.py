"""
Abstract base class for the letious polynomial Classes.

The ABCPolyBase class provides the methods needed to implement the common API
for the letious polynomial classes. It operates as a mixin, but uses the
...
class ABCPolyBase(abc.ABC):
    ...
    symbol : str
        Symbol representing the independent letiable.
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        ...
        w : array_like, shape (M,), optional
            ...
            the same letiance.  When using inverse-letiance weighting, use
            ``w[i] = 1/sigma(y[i])``.  The default value is None.
        window : {[beg, end]}, optional
            Window to use for the returned series. The default
            value is the default class domain
        symbol : str, optional
            Symbol representing the independent letiable. Default is 'x'.
