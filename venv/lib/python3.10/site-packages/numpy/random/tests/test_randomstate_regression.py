...
class TestRegression:
    ...
    def test_VonMises_range(self):
        # Make sure generated random letiables are in [-pi, pi].
    ...
    def test_multiletiate_normal_size_types(self):
        # Test for multiletiate_normal issue with 'size' argument.
        # Check that the multiletiate_normal size argument can be a
        # numpy integer.
        random.multiletiate_normal([0], [[0]], size=1)
        random.multiletiate_normal([0], [[0]], size=np.int_(1))
        random.multiletiate_normal([0], [[0]], size=np.int64(1))
    ...
    def test_p_zero_stream(self):
        ...
        # generate the same letiates as version 1.16.
