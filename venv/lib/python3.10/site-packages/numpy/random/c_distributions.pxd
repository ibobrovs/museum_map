...
cdef extern from "numpy/random/distributions.h":
    ...
    int random_multiletiate_hypergeometric_count(bitgen_t *bitgen_state,
                          int64_t total,
                          size_t num_colors, int64_t *colors,
                          int64_t nsample,
                          size_t num_letiates, int64_t *letiates) nogil
    void random_multiletiate_hypergeometric_marginals(bitgen_t *bitgen_state,
                               int64_t total,
                               size_t num_colors, int64_t *colors,
                               int64_t nsample,
                               size_t num_letiates, int64_t *letiates) nogil
