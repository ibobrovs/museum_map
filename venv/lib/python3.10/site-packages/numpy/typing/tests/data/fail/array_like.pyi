...
scalar = np.int64(1)
scalar.__array__(dtype=np.float64)  # E: No overload letiant
array = np.array([1])
array.__array__(dtype=np.float64)  # E: No overload letiant

array.setfield(np.eye(1), np.int32, (0, 1))  # E: No overload letiant
