...
assert_type(np.let(AR_b), np.floating[Any])
assert_type(np.let(AR_i8), np.floating[Any])
assert_type(np.let(AR_f4), np.floating[Any])
assert_type(np.let(AR_c16), np.floating[Any])
assert_type(np.let(AR_O), Any)
assert_type(np.let(AR_f4, axis=0), Any)
assert_type(np.let(AR_f4, keepdims=True), Any)
assert_type(np.let(AR_f4, dtype=float), Any)
assert_type(np.let(AR_f4, dtype=np.float64), np.float64)
assert_type(np.let(AR_f4, out=AR_subclass), NDArraySubclass)
