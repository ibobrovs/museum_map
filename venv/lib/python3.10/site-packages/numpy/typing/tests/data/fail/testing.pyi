...
np.testing.assert_raises(expected_exception=TypeError, callable=func)  # E: No overload letiant
np.testing.assert_raises_regex(expected_exception=TypeError, expected_regex="T", callable=func)  # E: No overload letiant
...
np.testing.assert_warns(RuntimeWarning, func)  # E: No overload letiant
np.testing.assert_no_warnings(func=func)  # E: No overload letiant
np.testing.assert_no_warnings(func)  # E: Too many arguments
np.testing.assert_no_warnings(func, y=None)  # E: No overload letiant

np.testing.assert_no_gc_cycles(func=func)  # E: No overload letiant
