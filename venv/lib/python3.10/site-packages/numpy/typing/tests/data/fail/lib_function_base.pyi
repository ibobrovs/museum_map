...
np.piecewise(AR_f8, True, [fn_ar_i], 42)  # E: No overload letiants
...
# np.piecewise(AR_f8, AR_b_list, [fn_none_i])  # E: No overload letiants
# np.piecewise(AR_f8, AR_b_list, [fn_ar_i])  # E: No overload letiant
# np.piecewise(AR_f8, AR_b_list, [fn_ar_i], 3.14)  # E: No overload letiant
# np.piecewise(AR_f8, AR_b_list, [fn_ar_i], 42, None)  # E: No overload letiant
# np.piecewise(AR_f8, AR_b_list, [fn_ar_i], 42, _=None)  # E: No overload letiant

np.interp(AR_f8, AR_c16, AR_f8)  # E: incompatible type
np.interp(AR_c16, AR_f8, AR_f8)  # E: incompatible type
np.interp(AR_f8, AR_f8, AR_f8, period=AR_c16)  # E: No overload letiant
...
np.corrcoef(AR_f8, bias=True)  # E: No overload letiant
np.corrcoef(AR_f8, ddof=2)  # E: No overload letiant
...
np.percentile(AR_f8, 50j)  # E: No overload letiant
np.percentile(AR_f8, 50, interpolation="bob")  # E: No overload letiant
np.quantile(AR_f8, 0.5j)  # E: No overload letiant
np.quantile(AR_f8, 0.5, interpolation="bob")  # E: No overload letiant
...
np.digitize(AR_f8, 1j)  # E: No overload letiant
