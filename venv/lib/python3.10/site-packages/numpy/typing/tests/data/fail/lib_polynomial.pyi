...
5**poly_obj  # E: No overload letiant

np.polyint(AR_U)  # E: incompatible type
np.polyint(AR_f8, m=1j)  # E: No overload letiant

np.polyder(AR_U)  # E: incompatible type
np.polyder(AR_f8, m=1j)  # E: No overload letiant

np.polyfit(AR_O, AR_f8, 1)  # E: incompatible type
np.polyfit(AR_f8, AR_f8, 1, rcond=1j)  # E: No overload letiant
np.polyfit(AR_f8, AR_f8, 1, w=AR_c16)  # E: incompatible type
np.polyfit(AR_f8, AR_f8, 1, cov="bob")  # E: No overload letiant
