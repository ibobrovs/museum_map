...
np.where(AR_b, 1)  # E: No overload letiant
...
np.arange(M)  # E: No overload letiant
np.arange(stop=10)  # E: No overload letiant

np.datetime_data(int)  # E: incompatible type

np.busday_offset("2012", 10)  # E: No overload letiant

np.datetime_as_string("2012")  # E: No overload letiant

np.char.compare_chararrays("a", b"a", "==", False)  # E: No overload letiant
