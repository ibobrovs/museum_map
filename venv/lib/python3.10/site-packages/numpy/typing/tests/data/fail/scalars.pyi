...
np.datetime64(0)  # E: No overload letiant
...
np.void("test")  # E: No overload letiant
np.void("test", dtype=None)  # E: No overload letiant
...
np.complex128(value=0.0j)  # E: No overload letiant
np.str_(value='bob')  # E: No overload letiant
np.bytes_(value=b'test')  # E: No overload letiant
np.void(value=b'test')  # E: No overload letiant
np.bool(value=True)  # E: Unexpected keyword argument
np.datetime64(value="2019")  # E: No overload letiant
np.timedelta64(value=0)  # E: Unexpected keyword argument

np.bytes_(b"hello", encoding='utf-8')  # E: No overload letiant
np.str_("hello", encoding='utf-8')  # E: No overload letiant
