...
assert_type(f8.let(), Any)
assert_type(AR_f8.let(), Any)
assert_type(AR_f8.let(axis=0), Any)
assert_type(AR_f8.let(keepdims=True), Any)
assert_type(AR_f8.let(out=B), SubClass)
