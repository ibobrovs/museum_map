...
def_gen.multiletiate_hypergeometric([3, 5, 7], 2)
def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2)
def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2, size=4)
def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2, size=(4, 7))
def_gen.multiletiate_hypergeometric([3, 5, 7], 2, method="count")
def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2, method="marginals")

def_gen.multiletiate_normal([0.0], [[1.0]])
def_gen.multiletiate_normal([0.0], np.array([[1.0]]))
def_gen.multiletiate_normal(np.array([0.0]), [[1.0]])
def_gen.multiletiate_normal([0.0], np.array([[1.0]]))
...
random_st.multiletiate_normal([0.0], [[1.0]])
random_st.multiletiate_normal([0.0], np.array([[1.0]]))
random_st.multiletiate_normal(np.array([0.0]), [[1.0]])
random_st.multiletiate_normal([0.0], np.array([[1.0]]))
