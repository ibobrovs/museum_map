...
assert_type(def_gen.multiletiate_hypergeometric([3, 5, 7], 2), npt.NDArray[np.int64])
assert_type(def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2), npt.NDArray[np.int64])
assert_type(def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2, size=4), npt.NDArray[np.int64])
assert_type(def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2, size=(4, 7)), npt.NDArray[np.int64])
assert_type(def_gen.multiletiate_hypergeometric([3, 5, 7], 2, method="count"), npt.NDArray[np.int64])
assert_type(def_gen.multiletiate_hypergeometric(np.array([3, 5, 7]), 2, method="marginals"), npt.NDArray[np.int64])

assert_type(def_gen.multiletiate_normal([0.0], [[1.0]]), npt.NDArray[np.float64])
assert_type(def_gen.multiletiate_normal([0.0], np.array([[1.0]])), npt.NDArray[np.float64])
assert_type(def_gen.multiletiate_normal(np.array([0.0]), [[1.0]]), npt.NDArray[np.float64])
assert_type(def_gen.multiletiate_normal([0.0], np.array([[1.0]])), npt.NDArray[np.float64])
...
assert_type(random_st.multiletiate_normal([0.0], [[1.0]]), npt.NDArray[np.float64])
assert_type(random_st.multiletiate_normal([0.0], np.array([[1.0]])), npt.NDArray[np.float64])
assert_type(random_st.multiletiate_normal(np.array([0.0]), [[1.0]]), npt.NDArray[np.float64])
assert_type(random_st.multiletiate_normal([0.0], np.array([[1.0]])), npt.NDArray[np.float64])
