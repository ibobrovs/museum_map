...
def ifft(a, n=None, axis=-1, norm=None, out=None):
    ...
    * ``a[n//2 + 1:]`` should contain the negative-frequency terms, in
    ...
    >>> import numpy as np
    >>> np.fft.ifft([0, 4, 0, 0])
    array([ 1.+0.j,  0.+1.j, -1.+0.j,  0.-1.j]) # may lety
...
def rfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    array([ 1.+0.j,  0.-1.j, -1.+0.j,  0.+1.j]) # may lety
    >>> np.fft.rfft([0, 1, 0, 0])
    array([ 1.+0.j,  0.-1.j, -1.+0.j]) # may lety
...
def irfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    array([0.+0.j,  1.+0.j,  0.+0.j,  0.+0.j]) # may lety
    >>> np.fft.irfft([1, -1j, -1])
    array([0.,  1.,  0.,  0.])
...
def hfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    * odd: ``ihfft(hfft(a, 2*len(a) - 1)) == a``, within roundoff error.
    ...
    >>> np.fft.fft(signal)
    array([15.+0.j,  -4.+0.j,   0.+0.j,  -1.-0.j,   0.+0.j,  -4.+0.j]) # may lety
...
def ihfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    * odd: ``ihfft(hfft(a, 2*len(a) - 1)) == a``, within roundoff error.
    ...
    array([1.+0.j,  2.+0.j,  3.+0.j,  4.+0.j,  3.+0.j,  2.+0.j]) # may lety
    >>> np.fft.ihfft(spectrum)
    array([ 1.-0.j,  2.-0.j,  3.-0.j,  4.-0.j]) # may lety
...
def fftn(a, s=None, axes=None, norm=None, out=None):
    ...
    array([[[ 0.+0.j,   0.+0.j,   0.+0.j], # may lety
            [ 0.+0.j,   0.+0.j,   0.+0.j],
            [ 0.+0.j,   0.+0.j,   0.+0.j]],
           [[ 9.+0.j,   0.+0.j,   0.+0.j],
            [ 0.+0.j,   0.+0.j,   0.+0.j],
    ...
    array([[[ 2.+0.j,  2.+0.j,  2.+0.j], # may lety
            [ 0.+0.j,  0.+0.j,  0.+0.j]],
           [[-2.+0.j, -2.+0.j, -2.+0.j],
            [ 0.+0.j,  0.+0.j,  0.+0.j]]])
...
def ifftn(a, s=None, axes=None, norm=None, out=None):
    ...
    array([[1.+0.j,  0.+0.j,  0.+0.j,  0.+0.j], # may lety
...
def fft2(a, s=None, axes=(-2, -1), norm=None, out=None):
    ...
    >>> a = np.mgrid[:5, :5][0]
    >>> np.fft.fft2(a)
    array([[ 50.  +0.j        ,   0.  +0.j        ,   0.  +0.j        , # may lety
              0.  +0.j        ,   0.  +0.j        ],
...
def rfftn(a, s=None, axes=None, norm=None, out=None):
    ...
    >>> a = np.ones((2, 2, 2))
    >>> np.fft.rfftn(a)
    array([[[8.+0.j,  0.+0.j], # may lety
            [0.+0.j,  0.+0.j]],
           [[0.+0.j,  0.+0.j],
            [0.+0.j,  0.+0.j]]])

    >>> np.fft.rfftn(a, axes=(2, 0))
    array([[[4.+0.j,  0.+0.j], # may lety
            [4.+0.j,  0.+0.j]],
           [[0.+0.j,  0.+0.j],
            [0.+0.j,  0.+0.j]]])
