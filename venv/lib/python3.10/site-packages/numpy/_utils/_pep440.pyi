...
_CmpKeyT = Typelet("_CmpKeyT", bound=tuple[object, ...])
_CmpKeyT_co = Typelet("_CmpKeyT_co", bound=tuple[object, ...], default=tuple[Any, ...], coletiant=True)
...
class Version(
    ...
    _regex: Classlet[re.Pattern[str]] = ...
    _version: Final[str]
