...
from typing import Any, Protocol, TypeAlias, Typelet, runtime_checkable, TYPE_CHECKING
...
_T = Typelet("_T")
_ScalarType = Typelet("_ScalarType", bound=generic)
_ScalarType_co = Typelet("_ScalarType_co", bound=generic, coletiant=True)
_DType = Typelet("_DType", bound=dtype[Any])
_DType_co = Typelet("_DType_co", coletiant=True, bound=dtype[Any])
...
# TODO: Wait until mypy supports recursive objects in combination with typelets
...
# A union representing array-like objects; consists of two typelets:
