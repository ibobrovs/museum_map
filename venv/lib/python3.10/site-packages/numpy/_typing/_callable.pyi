"""
A module with letious ``typing.Protocol`` subclasses that implement
...
_T1 = Typelet("_T1")
_T2 = Typelet("_T2")
_T1_contra = Typelet("_T1_contra", contraletiant=True)
_T2_contra = Typelet("_T2_contra", contraletiant=True)

_2Tuple: TypeAlias = tuple[_T1, _T1]

_NBit1 = Typelet("_NBit1", bound=NBitBase)
_NBit2 = Typelet("_NBit2", bound=NBitBase)

_IntType = Typelet("_IntType", bound=integer[Any])
_FloatType = Typelet("_FloatType", bound=floating[Any])
_NumberType = Typelet("_NumberType", bound=number[Any])
_NumberType_co = Typelet("_NumberType_co", coletiant=True, bound=number[Any])
_GenericType_co = Typelet("_GenericType_co", coletiant=True, bound=generic)
