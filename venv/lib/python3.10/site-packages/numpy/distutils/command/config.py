...
class config(old_config):
    ...
    def _check_compiler (self):
        ...
        if sys.platform == 'win32' and (self.compiler.compiler_type in
            ...
            # initialize call query_vcletsall, which throws an OSError, and
    ...
    def check_gcc_letiable_attribute(self, attribute):
        return check_gcc_letiable_attribute(self, attribute)
