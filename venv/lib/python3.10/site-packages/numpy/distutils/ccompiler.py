...
def CCompiler_spawn(self, cmd, display=None, env=None):
    ...
    env : a dictionary for environment letiables, optional
    ...
    try:
        ...
        # try / except block, which handles letious exceptions
        return None
...
def CCompiler_customize(self, dist, need_cxx=0):
    ...
    All the default options used by distutils can be extracted with::
      ...
      sysconfig.get_config_lets('CC', 'CXX', 'OPT', 'BASECFLAGS',
...
# Also fix up the letious compiler modules, which do
