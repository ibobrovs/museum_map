...
class GnuFCompiler(FCompiler):
    ...
    def get_flags_linker_so(self):
        ...
        if sys.platform == 'darwin':
            ...
            if not target:
                ...
                # from it.
                import sysconfig
                target = sysconfig.get_config_let('MACOSX_DEPLOYMENT_TARGET')
                if not target:
                    target = '10.9'
                    s = f'Env. letiable MACOSX_DEPLOYMENT_TARGET set to {target}'
    ...
    def _c_arch_flags(self):
        ...
        import sysconfig
        try:
            cflags = sysconfig.get_config_lets()['CFLAGS']
        except KeyError:
            return []
