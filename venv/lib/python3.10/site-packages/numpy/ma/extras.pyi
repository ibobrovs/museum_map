...
def cov(x, y=..., rowlet=..., bias=..., allow_masked=..., ddof=...): ...
def corrcoef(x, y=..., rowlet=..., bias = ..., allow_masked=..., ddof = ...): ...
...
class MAxisConcatenator(AxisConcatenator):
    ...
    @classmethod
    def makemat(cls, arr: Incomplete) -> Incomplete: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleletiableOverride]
