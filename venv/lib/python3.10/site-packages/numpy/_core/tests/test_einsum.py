...
class TestEinsum:
    ...
    def test_einsum_views(self):
        ...
        for do_opt in [True, False]:
            ...
            # diagonal with letious ways of broadcasting an additional dimension
            a = np.arange(27)
            a.shape = (3, 3, 3)
    ...
    def check_einsum_sums(self, dtype, do_opt=False):
        ...
        # Check letious sums.  Does many sizes to exercise unrolled loops.
        ...
        # letious stride0, contiguous, and SSE aligned letiants
        for n in range(1, 25):
            a = np.arange(n, dtype=dtype)
