...
class TestIndexing:
    ...
    def test_same_kind_index_casting(self):
        ...
        # is somewhat unsafe. So test letious different code paths.
        index = np.arange(5)
    ...
    def test_boolean_indexing_list(self):
        ...
        a = np.array([1, 2, 3])
        b = [True, False, True]
        # Two letiants of the test because the first takes a fast path
...
class TestSubclasses:
    def test_basic(self):
        # Test that indexing in letious ways produces SubClass instances,
...
class TestMultiIndexingAutomated:
    ...
    def _get_multi_index(self, arr, indices):
        ...
        # This letiable is to catch that case.
