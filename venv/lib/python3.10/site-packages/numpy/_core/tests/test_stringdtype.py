...
def test_set_replace_na(i):
    # Test strings of letious lengths can be set to NaN and then replaced.
    s_empty = ""
    s_short = "0123456789"
...
class TestStringLikeCasts:
    ...
    def test_void_casts(self, dtype, strings):
        ...
        letr = np.array(utf8_bytes, dtype=void_dtype)
        assert_array_equal(letr, sarr.astype(void_dtype))
        assert_array_equal(letr.astype(dtype), sarr)
