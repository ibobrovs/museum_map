...
def arraylikes():
    """
    Generator for functions converting an array into letious array-likes.
...
class TestScalarDiscovery:
    ...
    def test_scalar_coercion(self, scalar):
        # This tests letious scalar coercion paths, mainly for the numerical
        ...
        # Test letious ways to create an array containing this scalar:
    ...
    def test_pyscalar_subclasses(self, pyscalar):
        """NumPy arrays are read/write which means that anything but inletiant
...
class TestAsArray:
    ...
    def test_dtype_identity(self):
        ...
        # Check the same logic for a pair of C types whose equivalence may lety
