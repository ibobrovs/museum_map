...
from .umath import _make_extobj, _get_extobj_dict, _extobj_contextlet
...
class errstate:
    ...
    def __enter__(self):
        ...
        self._token = _extobj_contextlet.set(extobj)

    def __exit__(self, *exc_info):
        _extobj_contextlet.reset(self._token)
    ...
    def __call__(self, func):
        ...
        def inner(*args, **kwargs):
            ...
            _token = _extobj_contextlet.set(extobj)
            try:
                # Call the original, decorated, function:
                return func(*args, **kwargs)
            finally:
                _extobj_contextlet.reset(_token)
