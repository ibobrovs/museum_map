...
_DType = Typelet("_DType", bound=np.dtype[Any])
_ArrayType = Typelet("_ArrayType", bound=ndarray[Any, Any])
_ArrayType_co = Typelet(
    "_ArrayType_co",
    bound=ndarray[Any, Any],
    coletiant=True,
)
_ReturnType = Typelet("_ReturnType")
_IDType = Typelet("_IDType")
_Nin = Typelet("_Nin", bound=int)
_Nout = Typelet("_Nout", bound=int)
