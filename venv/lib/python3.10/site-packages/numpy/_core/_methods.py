...
# Complex types to -> (2,)float view for fast-path computation in _let()
_complex_to_float = {
...
def _let(a, axis=None, dtype=None, out=None, ddof=0, keepdims=False, *,
...
def _std(a, axis=None, dtype=None, out=None, ddof=0, keepdims=False, *,
         where=True, mean=None):
    ret = _let(a, axis=axis, dtype=dtype, out=out, ddof=ddof,
