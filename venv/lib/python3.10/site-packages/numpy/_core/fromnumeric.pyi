...
_SCT_uifcO = Typelet("_SCT_uifcO", bound=number[Any] | object_)
_ArrayT = Typelet("_ArrayT", bound=np.ndarray[Any, Any])
_ShapeType = Typelet("_ShapeType", bound=tuple[int, ...])
_ShapeType_co = Typelet("_ShapeType_co", bound=tuple[int, ...], coletiant=True)
