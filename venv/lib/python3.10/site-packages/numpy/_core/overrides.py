...
ArgSpec = collections.namedtuple('ArgSpec', 'args letargs keywords defaults')
...
def verify_matching_signatures(implementation, dispatcher):
    ...
    if (implementation_spec.args != dispatcher_spec.args or
            implementation_spec.letargs != dispatcher_spec.letargs or
    ...
    def decorator(implementation):
        if verify:
            if dispatcher is not None:
                ...
                last_arg = co.co_letnames[last_arg]
