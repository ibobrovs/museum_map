...
/*
 * Means c-style contiguous (last index leties the fastest). The data
...
/*
 * Set if array is a contiguous Fortran array: the first index leties
 ...
 * flags to the letious FromAny functions
 *
 * This flag may be requested in constructor functions.
 */
...
/* the letiable is used in some places, so always define it */
...
#define PyArray_HASFIELDS(obj) PyDataType_HASFIELDS(PyArray_DESCR(obj))
     ...
     * states whether or not it is letiable length.  Because the
     * ISFLEXIBLE check is hard-coded to the built-in data-types.
     */
#define PyArray_ISletIABLE(obj) PyTypeNum_ISFLEXIBLE(PyArray_TYPE(obj))

#define PyArray_SAFEALIGNEDCOPY(obj) (PyArray_ISALIGNED(obj) && !PyArray_ISletIABLE(obj))
