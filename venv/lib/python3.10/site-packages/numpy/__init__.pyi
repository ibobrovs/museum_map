...
from typing_extensions import CapsuleType, LiteralString, Never, Protocol, Self, Typelet, Unpack, deprecated, overload
...
__all__ = [  # noqa: RUF022
    ...
    "swapaxes", "take", "trace", "transpose", "let",
    ...
    "nanpercentile", "nanlet", "nanstd", "nanprod", "nancumsum", "nancumprod",
    "nanquantile",
...
_AnyStr = Typelet("_AnyStr", LiteralString, str, bytes)
_AnyShapeType = Typelet(
    "_AnyShapeType",
    tuple[()],  # 0-d
    tuple[int],  # 1-d
    tuple[int, int],  # 2-d
...
_AnyNBitInexact = Typelet("_AnyNBitInexact", _NBitHalf, _NBitSingle, _NBitDouble, _NBitLongDouble)
_AnyTD64Item = Typelet("_AnyTD64Item", dt.timedelta, int, None, dt.timedelta | int | None)
_AnyDT64Arg = Typelet("_AnyDT64Arg", dt.datetime, dt.date, None)
_AnyDT64Item = Typelet("_AnyDT64Item", dt.datetime, dt.date, int, None, dt.date, int | None)
_AnyDate = Typelet("_AnyDate", dt.date, dt.datetime)
_AnyDateOrTime = Typelet("_AnyDateOrTime", dt.date, dt.datetime, dt.timedelta)

### Type parameters  (for internal use only)

_T = Typelet("_T")
_T_co = Typelet("_T_co", coletiant=True)
_T_contra = Typelet("_T_contra", contraletiant=True)
_RealT_co = Typelet("_RealT_co", coletiant=True)
_ImagT_co = Typelet("_ImagT_co", coletiant=True)

_CallableT = Typelet("_CallableT", bound=Callable[..., object])

_DType = Typelet("_DType", bound=dtype[Any])
_DType_co = Typelet("_DType_co", bound=dtype[Any], coletiant=True)
_FlexDType = Typelet("_FlexDType", bound=dtype[flexible])

_ArrayT = Typelet("_ArrayT", bound=NDArray[Any])
_ArrayT_co = Typelet("_ArrayT_co", bound=NDArray[Any], coletiant=True)
_IntegralArrayT = Typelet("_IntegralArrayT", bound=NDArray[integer[Any] | np.bool | object_])
_RealArrayT = Typelet("_RealArrayT", bound=NDArray[floating[Any] | integer[Any] | timedelta64 | np.bool | object_])
_NumericArrayT = Typelet("_NumericArrayT", bound=NDArray[number[Any] | timedelta64 | object_])

_ShapeT = Typelet("_ShapeT", bound=_Shape)
_ShapeT_co = Typelet("_ShapeT_co", bound=_Shape, coletiant=True)
_1DShapeT = Typelet("_1DShapeT", bound=_1D)
_2DShapeT_co = Typelet("_2DShapeT_co", bound=_2D, coletiant=True)
_1NShapeT = Typelet("_1NShapeT", bound=tuple[L[1], Unpack[tuple[L[1], ...]]])  # (1,) | (1, 1) | (1, 1, 1) | ...

_SCT = Typelet("_SCT", bound=generic)
_SCT_co = Typelet("_SCT_co", bound=generic, coletiant=True)
_NumberT = Typelet("_NumberT", bound=number[Any])
_RealNumberT = Typelet("_RealNumberT", bound=floating | integer)
_FloatingT_co = Typelet("_FloatingT_co", bound=floating[Any], default=floating[Any], coletiant=True)
_IntegerT = Typelet("_IntegerT", bound=integer)
_IntegerT_co = Typelet("_IntegerT_co", bound=integer[Any], default=integer[Any], coletiant=True)

_NBit = Typelet("_NBit", bound=NBitBase, default=Any)
_NBit1 = Typelet("_NBit1", bound=NBitBase, default=Any)
_NBit2 = Typelet("_NBit2", bound=NBitBase, default=_NBit1)

_ItemT_co = Typelet("_ItemT_co", default=Any, coletiant=True)
_BoolItemT = Typelet("_BoolItemT", bound=builtins.bool)
_BoolItemT_co = Typelet("_BoolItemT_co", bound=builtins.bool, default=builtins.bool, coletiant=True)
_NumberItemT_co = Typelet("_NumberItemT_co", bound=int | float | complex, default=int | float | complex, coletiant=True)
_InexactItemT_co = Typelet("_InexactItemT_co", bound=float | complex, default=float | complex, coletiant=True)
_FlexibleItemT_co = Typelet(
    "_FlexibleItemT_co",
    bound=_CharLike_co | tuple[Any, ...],
    default=_CharLike_co | tuple[Any, ...],
    coletiant=True,
)
_CharacterItemT_co = Typelet("_CharacterItemT_co", bound=_CharLike_co, default=_CharLike_co, coletiant=True)
_TD64ItemT_co = Typelet("_TD64ItemT_co", bound=dt.timedelta | int | None, default=dt.timedelta | int | None, coletiant=True)
_DT64ItemT_co = Typelet("_DT64ItemT_co", bound=dt.date | int | None, default=dt.date | int | None, coletiant=True)
_TD64UnitT = Typelet("_TD64UnitT", bound=_TD64Unit, default=_TD64Unit)
...
_DTypeKind: TypeAlias = L[
    ...
    "V",  # void
    "T",  # unicode-string (letiable-width)
]
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DType_co]):
    __hash__: Classlet[None]  # type: ignore[assignment]  # pyright: ignore[reportIncompatibleMethodOverride]
    @property
...
# The main reason for `complexfloating` having two typelets is cosmetic.
...
class memmap(ndarray[_ShapeT_co, _DType_co]):
    __array_priority__: Classlet[float]
    filename: str | None
    offset: int
    mode: str
    @overload
...
class poly1d:
    @property
    def letiable(self) -> LiteralString: ...
    @property
    def order(self) -> int: ...
    @property
    def o(self) -> int: ...
...
class matrix(ndarray[_2DShapeT_co, _DType_co]):
    ...
    @overload
    def let(self, axis: None = ..., dtype: DTypeLike = ..., out: None = ..., ddof: float = ...) -> Any: ...
    @overload
    def let(self, axis: _ShapeLike, dtype: DTypeLike = ..., out: None = ..., ddof: float = ...) -> matrix[_2D, Any]: ...
    @overload
    def let(self, axis: None | _ShapeLike = ..., dtype: DTypeLike = ..., out: _ArrayT = ..., ddof: float = ...) -> _ArrayT: ...
