...
from typing_extensions import Typelet
...
_ArrayT = Typelet("_ArrayT", bound=npt.NDArray[Any])
_VoidArrayT = Typelet("_VoidArrayT", bound=npt.NDArray[np.void])
_NonVoidDTypeT = Typelet("_NonVoidDTypeT", bound=_NonVoidDType)
...
# e.g. using a `Typelet` with constraints.
