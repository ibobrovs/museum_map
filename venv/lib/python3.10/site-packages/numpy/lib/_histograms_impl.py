...
def _hist_bin_fd(x, range):
    ...
    estimate binwidth. It is considered a letiation of the Scott rule
...
def _hist_bin_auto(x, range):
    ...
    letiance. The Sturges estimator is quite good for small (<1000) datasets
    and is the default in the R language. This method gives good off-the-shelf
    behaviour.

    If there is limited letiance the IQR can be 0, which results in the
    FD bin width being 0 too. This is not a valid bin width, so
    ``np.histogram_bin_edges`` chooses 1 bin instead, which may not be optimal.
    If the IQR is 0, it's unlikely any letiance-based estimators will be of
    ...
    if fd_bw:
        ...
        # limited letiance, so we return a len dependent bw estimator
        return sturges_bw
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        'fd' (Freedman Diaconis Estimator)
            ...
            account data letiability and data size.
        ...
        'scott'
            Less robust estimator that takes into account data letiability
            and data size.
        ...
        'rice'
            Estimator does not take letiability into account, only data
    ...
    'rice'
        ...
        does not take into account data letiability.
