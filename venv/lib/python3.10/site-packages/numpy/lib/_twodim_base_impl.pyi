...
_SCT_complex = Typelet("_SCT_complex", bound=np.complexfloating)
_SCT_inexact = Typelet("_SCT_inexact", bound=np.inexact)
_SCT_number_co = Typelet("_SCT_number_co", bound=_Number_co)
