...
def show_runtime():
    """
    Print information about letious resources in the system
...
def get_include():
    ...
    --------
    >>> np.get_include()
    '.../site-packages/numpy/core/include'  # may lety
...
def deprecate(*args, **kwargs):
    ...
    DeprecationWarning: `uint64` is deprecated! # may lety
    >>> olduint(6)
    6
...
def info(object=None, maxwidth=76, output=None, toplevel='numpy'):
    ...
    contiguous:  True
    fortran:  False
    data pointer: 0x562b6e0d2860  # may lety
    byteorder:  little
    byteswap:  False
    type: complex64
