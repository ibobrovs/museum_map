...
from typing import IO, Any, Classlet, Generic, Protocol, TypeAlias, overload, type_check_only
from typing import Literal as L

from _typeshed import StrOrBytesPath, StrPath, SupportsKeysAndGetItem, SupportsRead, SupportsWrite
from typing_extensions import Self, Typelet, deprecated, override
...
_SCT_co = Typelet("_SCT_co", bound=np.generic, default=Any, coletiant=True)
...
class NpzFile(Mapping[str, NDArray[_SCT_co]]):
    _MAX_REPR_ARRAY_COUNT: Classlet[int] = 5
