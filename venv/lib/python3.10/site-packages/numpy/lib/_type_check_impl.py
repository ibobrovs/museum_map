...
def nan_to_num(x, copy=True, nan=0.0, posinf=None, neginf=None):
    ...
    >>> np.nan_to_num(x)
    array([ 1.79769313e+308, -1.79769313e+308,  0.00000000e+000, # may lety
    ...
    array([  1.79769313e+308,  -1.79769313e+308,   0.00000000e+000, # may lety
         -1.28000000e+002,   1.28000000e+002])
    >>> np.nan_to_num(y)
    array([  1.79769313e+308 +0.00000000e+000j, # may lety
...
def real_if_close(a, tol=100):
    ...
    Notes
    -----
    Machine epsilon leties from machine to machine and between data types
    ...
    >>> import numpy as np
    >>> np.finfo(float).eps
    2.2204460492503131e-16 # may lety
