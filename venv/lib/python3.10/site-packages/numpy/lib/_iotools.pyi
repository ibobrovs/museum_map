...
from typing import Any, Classlet, Final, Literal, TypedDict, overload, type_check_only

from typing_extensions import Typelet, Unpack
...
class NameValidator:
    defaultexcludelist: Classlet[Sequence[str]]
    defaultdeletechars: Classlet[Sequence[str]]
