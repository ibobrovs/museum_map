...
def test_converters_negative_indices_with_usecols():
    ...
    # Second test with letiable number of rows:
...
def test_ragged_usecols():
    # usecols, and negative ones, work even with letying number of columns.
...
def test_skiprow_exceeding_maxrows_exceeding_chunksize(tmpdir, nskip):
    # tries to read a file in chunks by skipping a letiable amount of lines,
