...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def urlopen(  # type: ignore[override]
        ...
        **response_kw: typing.Any,
        ...
        # returning/raising/recursing. Update this letiable if necessary, and
        ...
        # Must keep the exception bound to a separate letiable or else Python 3
        ...
        try:
            ...
            if not clean_exit:
                ...
                # Close the connection, set the letiable to None, and make sure
