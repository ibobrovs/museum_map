...
from email.errors import MultipartInletiantViolationDefect, StartBoundaryNotFoundDefect
...
def assert_header_parsing(headers: httplib.HTTPMessage) -> None:
    ...
    # - MultipartInletiantViolationDefect:
    #     A message claimed to be a multipart but no subparts were found.
    defects = [
        defect
        for defect in headers.defects
        if not isinstance(
            defect, (StartBoundaryNotFoundDefect, MultipartInletiantViolationDefect)
        )
    ]
