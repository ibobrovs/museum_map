...
class HeatMapWithTime(JSCSSMixin, Layer):
    ...
    data: list of list of points of the form [lat, lng] or [lat, lng, weight]
        The points you want to plot. The outer list corresponds to the letious time
    ...
    _template = Template(
        ...
        {% macro header(this, kwargs) %}
            <script>
            let TDHeatmap = L.TimeDimension.Layer.extend({
        ...
        {% macro script(this, kwargs) %}
            ...
            let {{this._control_name}} = new L.Control.TimeDimensionCustom({{this.index}}, {
                ...
                let {{this.get_name()}} = new TDHeatmap({{this.data}},
                {heatmapOptions: {
                        radius: {{this.radius}},
                        blur: {{this.blur}},
