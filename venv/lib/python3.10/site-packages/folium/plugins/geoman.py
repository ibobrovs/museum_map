...
class GeoMan(JSCSSMixin, MacroElement):
    ...
    _template = Template(
        ...
        {% macro script(this, kwargs) %}
            ...
            let {{this.get_name()}} = {{this._parent.get_name()}}.pm;
            {%- if this.feature_group  %}
                let drawnItems_{{ this.get_name() }} =
            ...
            {%- endif %}
            /* The global letiable below is needed to prevent streamlit-folium
               from barfing :-(
            */
            let drawnItems = drawnItems_{{ this.get_name() }};
