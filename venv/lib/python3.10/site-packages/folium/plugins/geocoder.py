...
class Geocoder(JSCSSMixin, MacroElement):
    ...
    _template = Template(
        ...
        {% macro script(this, kwargs) %}
            ...
            let geocoderOpts_{{ this.get_name() }} = {{ this.options|tojavascript }};

            // note: geocoder name should start with lowercase
            let geocoderName_{{ this.get_name() }} = geocoderOpts_{{ this.get_name() }}["provider"];

            let customGeocoder_{{ this.get_name() }} = L.Control.Geocoder[ geocoderName_{{ this.get_name() }} ](
            ...
            L.Control.geocoder(
                ...
                let zoom = geocoderOpts_{{ this.get_name() }}['zoom'] || {{ this._parent.get_name() }}.getZoom();
