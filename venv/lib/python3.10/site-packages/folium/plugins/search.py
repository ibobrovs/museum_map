    ...
    **kwargs.
    ...
    _template = Template(
        ...
        {% macro script(this, kwargs) %}
            let {{this.layer.get_name()}}searchControl = new L.Control.Search({
            ...
            {% else %}
                ...
                let zoom = {% if this.search_zoom %} {{ this.search_zoom }} {% else %} map.getBoundsZoom(latlng.layer.getBounds()) {% endif %}
