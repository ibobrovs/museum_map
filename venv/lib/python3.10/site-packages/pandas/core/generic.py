...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    __hash__: Classlet[None]  # type: ignore[assignment]
    ...
    def to_json(
        ...
        Notes
        -----
        The behavior of ``indent=0`` leties from the stdlib, which does not
    ...
    def reindex_like(
        ...
        tolerance : optional
            ...
            to all values, or list-like, which applies letiable tolerance per
    ...
    def astype(
        ...
        # (expression has type "Self", letiable has type "DataFrame")
    ...
    def copy(self, deep: bool_t | None = True) -> Self:
        ...
        original or copied letiable would not be reflected in the counterpart.
                ...
                for k, v in value.items():
                    ...
                    if was_no_default:
                        ...
                        downcast_k = (
                            ...
                            # Literal[_NoDefault.no_default], Any]", letiable has
                            # type "_NoDefault")
        ...
        *,
        ...
        if value is lib.no_default or method is not lib.no_default:
            ...
            if items:
                ...
                # "list[Never]", letiable has type "tuple[Any, ...]")
        ...
        **kwargs,
        ...
        method : str, default 'linear'
            ...
            * 'nearest', 'zero', 'slinear', 'quadratic', 'cubic',
              ...
              `scipy.interpolate.UniletiateSpline`. These methods use the numerical
        ...
        `SciPy documentation
        <https://docs.scipy.org/doc/scipy/reference/interpolate.html#uniletiate-interpolation>`__.
    ...
    def describe(
        ...
        will lety depending on what is provided. Refer to the notes
    ...
    def let(
        ...
        **kwargs,
        ...
        return self._stat_function_ddof(
            "let", nanops.nanlet, axis, skipna, ddof, numeric_only, **kwargs
        )
...
def make_doc(name: str, ndim: int) -> str:
    ...
    if name == "any":
        ...
        desc = (
            "Return unbiased letiance over requested axis.\n\nNormalized by "
            "N-1 by default. This can be changed using the ddof argument."
        )
        examples = _let_examples
        see_also = ""
        kwargs = {"notes": ""}
