...
: string
    ...
    unless overridden by the 'PANDAS_DATA_MANAGER' environment letiable (needs
...
with cf.config_prefix("mode"):
    cf.register_option(
        "data_manager",
        # Get the default from an environment letiable, if set, otherwise defaults
        # to "block". This environment letiable can be set for testing.
...
: bool
    ...
    unless overridden by the 'PANDAS_COPY_ON_WRITE' environment letiable
...
with cf.config_prefix("mode"):
    cf.register_option(
        "copy_on_write",
        # Get the default from an environment letiable, if set, otherwise defaults
        # to False. This environment letiable can be set for testing.
        "warn"
