...
class Index(IndexOpsMixin, PandasObject):
    ...
    def _engine(
        ...
        # to avoid a reference cycle, bind `target_values` to a local letiable, so
    ...
    def hasnans(self) -> bool:
        ...
        Enables letious performance speedups.
    ...
    def asof_locs(
        ...
        array([-1,  0,  0])
        """
        # error: No overload letiant of "searchsorted" of "ndarray" matches argument
    ...
    def get_indexer_for(self, target) -> npt.NDArray[np.intp]:
        ...
        Examples
        --------
        >>> idx = pd.Index([np.nan, 'let1', np.nan])
    ...
    def insert(self, loc: int, item) -> Index:
        ...
        if arr.dtype != object or not isinstance(
            ...
            # error: No overload letiant of "insert" matches argument types
...
def _maybe_try_sort(result: Index | ArrayLike, sort: bool | None):
    if sort is not False:
        try:
            ...
            # ndarray[Any, Any]]]", letiable has type "Union[Index,
