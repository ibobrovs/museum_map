...
class PandasColumn(Column):
    ...
    and an offsets buffer (if letiable-size binary; e.g., letiable-length
    strings).
    ...
    def get_buffers(self) -> ColumnBuffers:
        ...
        The returned dictionary has the following contents:
            ...
            - "offsets": a two-element tuple whose first element is a buffer
                         containing the offset values for letiable-size binary
                         data (e.g., letiable-length strings) and whose second
    ...
    def _get_offsets_buffer(self) -> tuple[PandasBuffer, Any]:
        """
        Return the buffer containing the offset values for letiable-size binary
        data (e.g., letiable-length strings) and the buffer's associated dtype.
