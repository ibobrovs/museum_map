...
def _replace_locals(tok: tuple[int, str]) -> tuple[int, str]:
    """
    Replace local letiables with a syntactically valid name.
...
class BaseExprVisitor(ast.NodeVisitor):
    ...
    const_type: Classlet[type[Term]] = Constant
    term_type: Classlet[type[Term]] = Term
    ...
    def _rewrite_membership_op(self, node, left, right):
        ...
        if is_term(left) and is_term(right) and op_type in self.rewrite_map:
            ...
            # pop the string letiable out of locals and replace it with a list
    ...
    def _maybe_eval(self, binop, eval_in_python):
        ...
        # temporary letiables. for example,
        # [1,2] in a + 2 * b
