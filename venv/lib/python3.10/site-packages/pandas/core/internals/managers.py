...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def iset(
        ...
        #        can prob also fix the letious if tests for sparse/categorical
        ...
        if lib.is_integer(loc):
            ...
            # "List[Union[int, slice, ndarray]]", letiable has type "Union[int,
            # slice, ndarray]")
    ...
    def _interleave(
        ...
        if not dtype:
            ...
            # "Optional[Union[dtype[Any], ExtensionDtype]]", letiable has
