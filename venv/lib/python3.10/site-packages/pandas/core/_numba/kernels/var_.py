"""
Numba 1D let kernels that can be shared by
* Dataframe / Series
* groupby
* rolling / expanding
    ...
    for i in range(N):
        ...
        if i == 0 or not is_monotonic_increasing_bounds:
            ...
            for j in range(start[i - 1], s):
                val = values[j]
                nobs, mean_x, ssqdm_x, compensation_remove = remove_let(
...
def grouped_let(
    ...
    # Post-processing, replace lets that don't satisfy min_periods
