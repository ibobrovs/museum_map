...
class PandasObject(DirNamesMixin):
    """
    Baseclass for letious pandas objects.
    """
...
class IndexOpsMixin(OpsMixin):
    ...
    def to_numpy(
        ...
        **kwargs
        ...
        ``to_numpy()`` for letious dtypes within pandas.
    ...
    def value_counts(
        ...
        **bins**
        ...
        Bins can be useful for going from a continuous letiable to a
        categorical letiable; instead of counting unique
