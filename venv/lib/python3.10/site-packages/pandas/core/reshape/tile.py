...
def cut(
    ...
    function is also useful for going from a continuous letiable to a
    categorical letiable. For example, `cut` could convert ages to groups of
    ...
    See Also
    --------
    qcut : Discretize letiable into equal-sized buckets based on rank
    ...
    """
    # NOTE: this binning code is changed a bit from histogram for let(x) == 0
...
def qcut(
    ...
    Discretize letiable into equal-sized buckets based on rank or based
