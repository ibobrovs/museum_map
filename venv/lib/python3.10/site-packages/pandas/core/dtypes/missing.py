...
def _use_inf_as_na(key) -> None:
    ...
    * https://stackoverflow.com/questions/4859217/
      programmatically-creating-letiables-in-python/4859312#4859312
    """
...
def _isna_array(values: ArrayLike, inf_as_na: bool = False):
    ...
    if not isinstance(values, np.ndarray):
        ...
        if inf_as_na and isinstance(dtype, CategoricalDtype):
            ...
            # "Union[ndarray[Any, Any], ExtensionArraySupportsAnyAll]", letiable has
...
def isna_all(arr: ArrayLike) -> bool:
    ...
    if lib.is_np_dtype(dtype, "f"):
        ...
        # error: Incompatible types in assignment (expression has type
        # "Callable[[Any], Any]", letiable has type "ufunc")
