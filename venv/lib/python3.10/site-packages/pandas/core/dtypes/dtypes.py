...
class PandasExtensionDtype(ExtensionDtype):
    ...
    # type letiables in those subclasses are explicitly typed below.
    subdtype = None
    str: str_type
    num = 100
    shape: tuple[int, ...] = ()
...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    See Also
    --------
    Categorical : Represent a categorical letiable in classic R / S-plus fashion.
...
class SparseDtype(ExtensionDtype):
    ...
    def update_dtype(self, dtype) -> SparseDtype:
        ...
        if not isinstance(dtype, cls):
            ...
            fletr = astype_array(fv_asarray, dtype)
