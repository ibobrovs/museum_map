...
class StringMethods(NoNewAttributesMixin):
    ...
    def cat(
        ...
        if others is None:
            ...
            # "ndarray", letiable has type "Series")
    ...
    def get_dummies(self, sep: str = "|"):
        """
        Return DataFrame of dummy/indicator letiables for Series.

        Each string in Series is split by sep and returned as a DataFrame
        of dummy/indicator letiables.
        ...
        -------
        DataFrame
            Dummy letiables corresponding to values of the Series.

        See Also
        --------
        get_dummies : Convert categorical letiable into dummy/indicator
            letiables.
