...
class DataFrame(NDFrame, OpsMixin):
        ...
        if orient == "index":
            if len(data) > 0:
                ...
                if isinstance(next(iter(data.values())), (Series, dict)):
                    ...
                    # "List[Any]", letiable has type "Dict[Any, Any]")
    ...
    def to_stata(
        ...
        *,
        ...
        letiable_labels : dict
            Dictionary containing columns as keys and letiable labels as
        ...
        version : {{114, 117, 118, 119, None}}, default 114
            ...
            Stata 15 and later. Version 114 limits string letiables to 244
            ...
            letiables exceeds the capacity of dta format 118. Exporting
        ...
        value_labels : dict of dicts
            ...
            to labels as values. Labels for a single letiable must be 32,000
    ...
    def query(self, expr: str, *, inplace: bool = False, **kwargs) -> DataFrame | None:
        ...
        expr : str
            ...
            You can refer to letiables
            in the environment by prefixing them with an '@' character like
            ``@a + b``.

            You can refer to column names that are not valid Python letiable names
        ...
        *Backtick quoted letiables*

        Backtick quoted letiables are parsed as literal Python code and
    ...
    def eval(self, expr: str, *, inplace: bool = False, **kwargs) -> Any | None:
        ...
        **kwargs
        ...
        DataFrame.assign : Can evaluate an expression or function to create new
            values for a column.
        eval : Evaluate a Python expression as a string using letious
            backends.
    ...
    def duplicated(
        ...
        if subset is None:
            ...
            # Incompatible types in assignment (expression has type "Index", letiable
    ...
    def sort_values(
        ...
        *,
        ...
        if len(by) > 1:
            ...
            if key is not None:
                # error: Incompatible types in assignment (expression has type
                # "Series", letiable has type "ndarray")
    ...
    def combine(
        ...
        for col in new_columns:
            ...
            if isinstance(new_dtype, np.dtype):
                ...
                # error: No overload letiant of "maybe_downcast_to_dtype" matches
    ...
    def round(
        ...
        """
        Round a DataFrame to a letiable number of decimal places.
        ...
        decimals : int, dict, Series
            ...
            Otherwise dict and Series round to letiable numbers of places.
    ...
    def cov(
        ...
        """
        Compute pairwise coletiance of columns, excluding NA/null values.

        Compute the pairwise coletiance among the series of a DataFrame.
        The returned data frame is the `coletiance matrix
        <https://en.wikipedia.org/wiki/Coletiance_matrix>`__ of the columns
        of the DataFrame.
        ...
        -------
        DataFrame
            The coletiance matrix of the series of the DataFrame.

        See Also
        --------
        Series.cov : Compute coletiance with another Series.
        core.window.ewm.ExponentialMovingWindow.cov : Exponential weighted sample
            coletiance.
        core.window.expanding.Expanding.cov : Expanding sample coletiance.
        core.window.rolling.Rolling.cov : Rolling sample coletiance.

        Notes
        -----
        Returns the coletiance matrix of the DataFrame's time series.
        The coletiance is normalized by N-ddof.

        For DataFrames that have Series that are missing data (assuming that
        data is `missing at random
        <https://en.wikipedia.org/wiki/Missing_data#Missing_at_random>`__)
        the returned coletiance matrix will be an unbiased estimate
        of the letiance and coletiance between the member Series.

        However, for many applications this estimate may not be acceptable
        because the estimate coletiance matrix is not guaranteed to be positive
        semi-definite. This could lead to estimate correlations having
        absolute values which are greater than one, and/or a non-invertible
        coletiance matrix. See `Estimation of coletiance matrices
        <https://en.wikipedia.org/w/index.php?title=Estimation_of_coletiance_
    ...
    def _reduce_axis1(self, name: str, func, skipna: bool) -> Series:
        ...
        if name == "all":
            ...
            # Literal[20], Literal[False]]", letiable has type
    ...
    def let(
        ...
        **kwargs,
        ...
        result = super().let(axis, skipna, ddof, numeric_only, **kwargs)
        if isinstance(result, Series):
            result = result.__finalize__(self, method="let")
        return result
