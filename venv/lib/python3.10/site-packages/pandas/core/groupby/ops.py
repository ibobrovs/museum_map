...
class WrappedCythonOp:
    ...
    _CYTHON_FUNCTIONS: dict[str, dict] = {
        "aggregate": {
            ...
            "let": "group_let",
            "std": functools.partial(libgroupby.group_let, name="std"),
            "sem": functools.partial(libgroupby.group_let, name="sem"),
            "skew": "group_skew",
            "first": "group_nth",
            "last": "group_last",
            "ohlc": "group_ohlc",
    ...
    def _get_result_dtype(self, dtype: np.dtype) -> np.dtype:
        ...
        elif how in ["mean", "median", "let", "std", "sem"]:
            if dtype.kind in "fc":
                return dtype
    ...
    def _call_cython_op(
        ...
        **kwargs,
        ...
        if self.kind == "aggregate":
            ...
            elif self.how in ["sem", "std", "let", "ohlc", "prod", "median"]:
