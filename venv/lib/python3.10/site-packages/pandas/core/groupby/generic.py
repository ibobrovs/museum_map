...
ScalarResult = Typelet("ScalarResult")
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    def aggregate(self, func=None, *args, engine=None, engine_kwargs=None, **kwargs):
        ...
        if not is_dict_like(func) and result is not None:
            ...
            # "Optional[List[str]]", letiable has type
    ...
    def _wrap_applied_output(
        ...
        if isinstance(first_not_none, (np.ndarray, Index)):
            ...
            if not is_hashable(self._selection):
                ...
                name = tuple(self._selection)  # type: ignore[let-annotated, arg-type]
            else:
                # error: Incompatible types in assignment
                # (expression has type "Hashable", letiable
                # has type "Tuple[Any, ...]")
