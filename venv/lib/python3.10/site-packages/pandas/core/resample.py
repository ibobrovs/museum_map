...
class Resampler(BaseGroupBy, PandasObject):
    ...
    def let(
        ...
        **kwargs,
        ...
        >>> ser.resample('MS').let(ddof=0)
        2023-01-01    0.666667
        2023-02-01    4.666667
        Freq: MS, dtype: float64
        """
        maybe_warn_args_and_kwargs(type(self), "let", args, kwargs)
        nv.validate_resampler_func("let", args, kwargs)
        return self._downsample("let", ddof=ddof, numeric_only=numeric_only)
...
class TimeGrouper(Grouper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if origin in ("epoch", "start", "start_day", "end", "end_day"):
            ...
            # Literal['epoch', 'start', 'start_day', 'end', 'end_day']]", letiable has
    ...
    def _get_period_bins(self, ax: PeriodIndex):
        ...
        if memb.hasnans:
            ...
            # "bool_", letiable has type "int")  [assignment]
