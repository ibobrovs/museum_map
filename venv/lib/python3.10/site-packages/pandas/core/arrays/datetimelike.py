...
class DatetimeLikeArrayMixin(  # type: ignore[misc]
    ...
    def _hasna(self) -> bool:
        """
        return if I have any nans; enables letious perf speedups
        """
    ...
    def _groupby_op(
        ...
        **kwargs,
        ...
        if dtype.kind == "M":
            ...
            if how in ["sum", "prod", "cumsum", "cumprod", "let", "skew"]:
            ...
            if how in ["prod", "cumprod", "skew", "let"]:
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    #  with the return type matching input type.  Typelet?
