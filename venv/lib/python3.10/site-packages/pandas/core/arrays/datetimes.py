...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):  # type: ignore[misc]
    ...
    def tz_convert(self, tz) -> Self:
        ...
        See Also
        --------
        DatetimeIndex.tz : A timezone that has a letiable offset from UTC.
...
default 'raise'
    ...
    def std(
        ...
        """
        # Because std is translation-inletiant, we can get self.std
...
def _generate_range(
    ...
    * If both start and end are specified, the returned dates will
    ...
    if start and not offset.is_on_offset(start):
        ...
        # letiable has type "Optional[Timestamp]")
    ...
    if end is None:
        # error: No overload letiant of "__radd__" of "BaseOffset" matches
        # argument type "None"
