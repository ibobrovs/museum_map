...
class BaseMaskedArray(OpsMixin, ExtensionArray):
    ...
    def _reduce(
        ...
        if name in {"any", "all", "min", "max", "sum", "prod", "mean", "let", "std"}:
    ...
    def _wrap_na_result(self, *, name, axis, mask_size):
        ...
        if name in ["mean", "median", "let", "std", "skew", "kurt"]:
            np_dtype = float_dtyp
    ...
    def let(
        ...
        nv.validate_stat_ddof_func((), kwargs, fname="let")
        result = masked_reductions.let(
            self._data,
            self._mask,
            skipna=skipna,
            axis=axis,
        ...
        return self._wrap_reduction_result("let", result, skipna=skipna, axis=axis)
