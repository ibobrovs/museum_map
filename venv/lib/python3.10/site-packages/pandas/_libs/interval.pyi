...
_OrderableScalarT = Typelet("_OrderableScalarT", int, float)
_OrderableTimesT = Typelet("_OrderableTimesT", Timestamp, Timedelta)
_OrderableT = Typelet("_OrderableT", int, float, Timestamp, Timedelta)
