...
_BaseOffsetT = Typelet("_BaseOffsetT", bound=BaseOffset)
_DatetimeT = Typelet("_DatetimeT", bound=datetime)
_TimedeltaT = Typelet("_TimedeltaT", bound=timedelta)
...
class FY5253Mixin(SingleConstructorOffset):
    def __init__(
        ...
        weekday: int = ...,
        startingMonth: int = ...,
        letiation: Literal["nearest", "last"] = ...,
    ) -> None: ...
