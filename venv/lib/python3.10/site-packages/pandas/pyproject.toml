...
ignore = [
  ...
  # false positives
  "B019",
  # Loop control letiable overrides iterable it iterates
  "B020",
  # Function definition does not bind loop letiable
  "B023",
  # Functions defined inside a loop must not use letiables redefined in the loop
...
disable = [
 ...
 # pylint type "C": convention, for programming standard violation
  ...
  "keyword-arg-before-letarg",
  "possibly-unused-letiable",
  "protected-access",
  "raise-missing-from",
  "redefined-builtin",
