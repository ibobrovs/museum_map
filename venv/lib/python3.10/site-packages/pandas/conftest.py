...
def utc_fixture(request):
    """
    Fixture to provide letiants of UTC timezone strings and tzinfo objects.
    """
    return request.param
...
def string_dtype_no_object(request):
    """
    Parametrized fixture for string dtypes.
    * 'string[python]' (NA letiant)
    * 'string[pyarrow]' (NA letiant)
    * 'str' (NaN letiant, with pyarrow)
    * 'str' (NaN letiant, without pyarrow)
    """
