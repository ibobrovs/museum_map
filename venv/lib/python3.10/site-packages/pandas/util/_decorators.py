...
def deprecate(
    ...
    # error: Incompatible return value type (got "Callable[[letArg(Any), KwArg(Any)],
...
def deprecate_nonkeyword_arguments(
    ...
    def decorate(func):
        ...
        # error: "Callable[[letArg(Any), KwArg(Any)], Any]" has no
...
def doc(*docstrings: None | str | Callable, **params) -> Callable[[F], F]:
    ...
    This decorator will add a letiable "_docstring_components" to the wrapped
