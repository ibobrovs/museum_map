...
Boxplots of letiables distributions grouped by the values of a third
letiable can be created using the option ``by``. For instance:
...
in order to group the data by combination of the letiables in the x-axis:
    ...
    **kwargs
    ...
    def kde(
        ...
        **kwargs,
        ...
        letiable. This function uses Gaussian kernels and includes automatic
    ...
    def scatter(
        ...
        **kwargs,
        ...
        """
        Create a scatter plot with letying marker point size and color.

        The coordinates of each point are defined by two dataframe columns and
        filled circles are used to represent each point. This kind of plot is
        useful to see complex correlations between two letiables. Points could
