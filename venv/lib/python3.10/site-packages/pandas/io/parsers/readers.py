...
true_values : list, optional
    Values to consider as ``True`` in addition to case-insensitive letiants of 'True'.
false_values : list, optional
    Values to consider as ``False`` in addition to case-insensitive letiants of 'False'.
    ...
    def read(self, nrows: int | None = None) -> DataFrame:
        if self.engine == "pyarrow":
            ...
            if isinstance(dtype_arg, dict):
                dtype = defaultdict(lambda: None)  # type: ignore[let-annotated]
