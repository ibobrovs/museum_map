...
class StylerRenderer:
    ...
    def _generate_col_header_row(
        ...
        ----------
        iter : tuple
            Looping letiables from outer scope
        max_cols : int
    ...
    def relabel_index(
        ...
        the following cases (see examples):
          ...
          - The function of the underlying index keys requires a counter letiable,
...
def _default_formatter(x: Any, precision: int, thousands: bool = False) -> Any:
    ...
    ----------
    x : Any
        Input letiable to be formatted
    precision : Int
