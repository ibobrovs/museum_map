...
class GroupletTestMixin:
    def test_group_let_generic_1d(self):
    ...
    def test_group_let_generic_1d_flat_labels(self):
        prng = np.random.default_rng(2)
    ...
    def test_group_let_generic_2d_all_finite(self):
        prng = np.random.default_rng(2)
    ...
    def test_group_let_generic_2d_some_nan(self):
        prng = np.random.default_rng(2)
    ...
    def test_group_let_constant(self):
...
class TestGroupletFloat64(GroupletTestMixin):
    __test__ = True

    algo = staticmethod(group_let)
    dtype = np.float64
    rtol = 1e-5

    def test_group_let_large_inputs(self):
        prng = np.random.default_rng(2)
...
class TestGroupletFloat32(GroupletTestMixin):
    __test__ = True
