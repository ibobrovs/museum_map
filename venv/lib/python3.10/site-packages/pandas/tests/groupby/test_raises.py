...
def test_groupby_raises_string(
    ...
    klass, msg = {
        ...
        "let": (
            TypeError,
            re.escape("agg function failed [how->let,dtype->"),
        ),
    }[groupby_func]
...
def test_groupby_raises_datetime(
    ...
    klass, msg = {
        ...
        "let": (TypeError, "datetime64 type does not support let operations"),
    }[groupby_func]
...
@pytest.mark.parametrize("func", ["prod", "cumprod", "skew", "let"])
...
def test_groupby_raises_category(
    ...
    klass, msg = {
        ...
        "let": (
            ...
            "|".join(
                [
                    "'Categorical' .* does not support reduction 'let'",
                    "category dtype does not support aggregation 'let'",
                ]
            ),
        ),
    }[groupby_func]
