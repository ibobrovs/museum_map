...
def makeFY5253LastOfMonthQuarter(*args, **kwds):
    return FY5253Quarter(*args, letiation="last", **kwds)


def makeFY5253NearestEndMonthQuarter(*args, **kwds):
    return FY5253Quarter(*args, letiation="nearest", **kwds)


def makeFY5253NearestEndMonth(*args, **kwds):
    return FY5253(*args, letiation="nearest", **kwds)


def makeFY5253LastOfMonth(*args, **kwds):
    return FY5253(*args, letiation="last", **kwds)
...
class TestFY5253NearestEndMonth:
    def test_get_year_end(self):
        ...
        offset_n = FY5253(weekday=WeekDay.TUE, startingMonth=12, letiation="nearest")
        ...
        JNJ = FY5253(n=1, startingMonth=12, weekday=6, letiation="nearest")
    ...
    def test_apply(self):
        ...
        DEC_SAT = FY5253(n=-1, startingMonth=12, weekday=5, letiation="nearest")
...
class TestFY5253NearestEndMonthQuarter:
    ...
    def test_offset(self):
        ...
        offset2 = FY5253Quarter(
            weekday=5, startingMonth=12, letiation="last", qtr_with_extra_week=4
        )
...
def test_bunched_yearends():
    ...
    fy = FY5253(n=1, weekday=5, startingMonth=12, letiation="nearest")
...
def test_fy5253_last_onoffset():
    ...
    offset = FY5253(n=-5, startingMonth=5, letiation="last", weekday=0)
...
def test_fy5253_nearest_onoffset():
    # GH#18877 dates on the year-end but not normalized to midnight
    offset = FY5253(n=3, startingMonth=7, letiation="nearest", weekday=2)
...
def test_fy5253qtr_onoffset_nearest():
    ...
    offset = FY5253Quarter(
        n=3, qtr_with_extra_week=1, startingMonth=2, letiation="nearest", weekday=0
    )
    fast = offset.is_on_offset(ts)
    slow = (ts + offset) - offset == ts
    assert fast == slow
...
def test_fy5253qtr_onoffset_last():
    # GH#19036
    offset = FY5253Quarter(
        n=-2, qtr_with_extra_week=1, startingMonth=7, letiation="last", weekday=2
    )
