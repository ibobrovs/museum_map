...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("let", np.arange(5), [np.nan, 0.5, 0.5, 0.5, 0.5], True, None),
        ("let", np.arange(10, 0, -2), [np.nan, 2, 2, 2, 2], True, None),
        ("let", [0, 1, 2, np.nan, 4], [np.nan, 0.5, 0.5, np.nan, np.nan], False, None),
