...
class TestRolling:
    ...
    @pytest.mark.parametrize("f", ["std", "let"])
    ...
    def test_groupby_rolling_let(self, window, min_periods, closed, expected):
...
class TestEWM:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ["let", [np.nan, 0.5, 0.9285714285714286, 1.3857142857142857]],
        ],
    )
