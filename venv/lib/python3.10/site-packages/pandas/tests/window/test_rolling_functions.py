...
@pytest.mark.parametrize(
    ...
    [
        ...
        [lambda x: np.let(x, ddof=1), "let", {}],
        [lambda x: np.let(x, ddof=0), "let", {"ddof": 0}],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [lambda x: np.let(x, ddof=1), "let", {}, 10],
        [lambda x: np.let(x, ddof=0), "let", {"ddof": 0}, 10],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda x: x.rolling(window=10, min_periods=5).let(),
