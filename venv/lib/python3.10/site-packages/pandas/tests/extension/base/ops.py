...
class BaseArithmeticOpsTests(BaseOpsUtil):
    """
    letious Series and DataFrame arithmetic ops methods.

    Subclasses supporting letious ops should set the class letiables
...
class BaseComparisonOpsTests(BaseOpsUtil):
    """letious Series and DataFrame comparison ops methods."""
