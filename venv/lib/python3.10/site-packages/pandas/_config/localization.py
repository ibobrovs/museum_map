...
@contextmanager
def set_locale(
    new_locale: str | tuple[str, str], lc_let: int = locale.LC_ALL
    ...
    new_locale : str or tuple
        ...
        "en_US.UTF-8".
    lc_let : int, default `locale.LC_ALL`
    ...
    current_locale = locale.setlocale(lc_let)

    try:
        locale.setlocale(lc_let, new_locale)
        ...
        locale.setlocale(lc_let, current_locale)


def can_set_locale(lc: str, lc_let: int = locale.LC_ALL) -> bool:
    """
    ...
    """
    try:
        with set_locale(lc, lc_let=lc_let):
            pass
