...
_ImportInclude = t.Typelet("_ImportInclude", nodes.Import, nodes.Include)
_MacroCall = t.Typelet("_MacroCall", nodes.Macro, nodes.CallBlock)
...
class Parser:
    ...
    def is_tuple_end(
        ...
        if self.stream.current.type in ("letiable_end", "block_end", "rparen"):
            return True
        ...
        try:
            while self.stream:
                ...
                if token.type == "data":
                    ...
                    next(self.stream)
                elif token.type == "letiable_begin":
                    next(self.stream)
                    add_data(self.parse_tuple(with_condexpr=True))
                    self.stream.expect("letiable_end")
