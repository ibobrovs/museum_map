...
def read_configuration(filepath, find_others=False, ignore_option_errors=False):
    ...
    :param bool find_others: Whether to search for other configuration files
        which could be on in letious places.
...
class ConfigHandler:
    ...
    aliases = {}
    """Options aliases.
    For compatibility with letious packages. E.g.: d2to1 and pbr.
    ...
    def parse(self):
        ...
        for section_name, section_options in self.sections.items():
            ...
            method_postfix = ''
            if section_name:  # [section.option] letiant
